...
Full binary tree: a full binary tree (referenced to as a proper or plane binary tree) is
...
pre-order: Check if current node is empty, display the data part of the root or current node
            traverse the left subtree by recursively calling the pre-order function
            traverse the right subtree by recursively calling the pre-order function
    
in-order: Check in the current node is empty, traverse the left subtree by recursively calling the
            inorder function. Display the data part of the root or current node, Traverse the right 
            subtree by recursively calling the inorder function
